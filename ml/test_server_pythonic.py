...
app = Flask(__name__)
CORS(app, resources={r"/*": {"origins": ["https://medic-reminder-two.vercel.app", "https://medicreminder-production-aaca.up.railway.app","https://medicreminder-production-0f69.up.railway.app"]}}, supports_credentials=True)
